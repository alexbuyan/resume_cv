...
\resumeSubHeadingListStart
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Combined} \href{https://ollama.com/library/llama3}{\textit{Llama3:8b}} and \href{https://huggingface.co/sentence-transformers}{\textit{sentence-transformers}} embeddings for retrieval-augmented generation}
        ...
        \resumeItem{Developed a \textbf{Telegram bot} to upload PDF files and interact with the RAG model}
      \resumeItemListEnd
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Set up} Hadoop cluster and Spark session to work with datasets}
        \resumeItem{Worked with datasets using \textbf{PySpark} to describe the data}
        \resumeItem{\textbf{Trained} SGDRegressor to predict the movie rating based on tags dataset}
      \resumeItemListEnd
    \resumeProjectHeading
